...
#include "Project08/Public/SpawnVolume.h"
...
PROJECT08_API UClass* Z_Construct_UClass_ASpawnVolume();
PROJECT08_API UClass* Z_Construct_UClass_ASpawnVolume_NoRegister();
...
struct Z_Construct_UClass_ASpawnVolume_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ItemDataTabel_MetaData[] = {
		{ "Category", "Spawning" },
		{ "ModuleRelativePath", "Public/SpawnVolume.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ItemDataTabel;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpawnVolume_Statics::NewProp_ItemDataTabel = { "ItemDataTabel", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpawnVolume, ItemDataTabel), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ItemDataTabel_MetaData), NewProp_ItemDataTabel_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpawnVolume_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpawnVolume_Statics::NewProp_ItemDataTabel,
};
...
template<> PROJECT08_API UClass* StaticClass<ASpawnVolume>()
{
	return ASpawnVolume::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Project08_Source_Project08_Public_SpawnVolume_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASpawnVolume, ASpawnVolume::StaticClass, TEXT("ASpawnVolume"), &Z_Registration_Info_UClass_ASpawnVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpawnVolume), 2010452292U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project08_Source_Project08_Public_SpawnVolume_h_3601209918(TEXT("/Script/Project08"),
	Z_CompiledInDeferFile_FID_Project08_Source_Project08_Public_SpawnVolume_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Project08_Source_Project08_Public_SpawnVolume_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration

...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABaseItem_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UItemInterface_NoRegister, (int32)VTABLE_OFFSET(ABaseItem, IItemInterface), false },  // 2718735435
};
...
struct Z_CompiledInDeferFile_FID_Project08_Source_Project08_Public_BaseItem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABaseItem, ABaseItem::StaticClass, TEXT("ABaseItem"), &Z_Registration_Info_UClass_ABaseItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABaseItem), 2535948853U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project08_Source_Project08_Public_BaseItem_h_2511148225(TEXT("/Script/Project08"),
